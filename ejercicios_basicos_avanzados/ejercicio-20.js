...
// Recorremos el array de juguetes con un bucle for...of, se va asignando cada elemento a la variable (toy)
// Así, en cada vuelta del bucle, podemos acceder a las propiedades de cada juguete (toy.id, toy.name, toy.sellCount)
    if (toy.sellCount > 15) {
        popularToys.push(toy);
    }
}

console.log("El array de los juguetes populares es:", popularToys);
