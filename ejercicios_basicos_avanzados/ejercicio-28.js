...
let totalDuration = 0; // Inicializo la variable a 0

for (let i = 0; i < albums.length; i++) {
  if (albums[i].genre === 'Rock') { // Comprobamos si el género del álbum es 'Rock'
    totalDuration += albums[i].duration; // Sumamos la duración del álbum a la variable totalDuration
  }
}
